...
# NOT YET FUNCTIONAL — host.py and com.securityco.host.json are still
# stubs/templates. Fill those in first (spec section 15, build order step 9),
# then this script's job is: write com.securityco.host.json somewhere
# stable, rewrite its "path" to an absolute path, fill in the real extension
# ID in "allowed_origins", and register
#   HKEY_CURRENT_USER\Software\Google\Chrome\NativeMessagingHosts\com.securityco.host
