...
files (`com.securityco.host.json`, `install.sh`, `install.ps1`)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Security Co native helper — watch flows, escalate anomalies.")
