...
Domain services raise typed `SecurityCoError` subclasses (see
...
from exceptions import SecurityCoError
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(SecurityCoError)
    async def handle_domain_error(request: Request, exc: SecurityCoError) -> JSONResponse:
