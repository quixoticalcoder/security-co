...
or Chrome extension required (see security-co-poc-scope memory:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a case through the Security Co agent from the terminal.")
