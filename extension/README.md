# Security Co browser extension

Chrome Manifest V3 extension for the Security Co investigation service (`backend/`). It does **not** run any AI models or
...
5. Click the Security Co icon in the toolbar on any `http(s)://` page and use **Check this URL** or
   **Check page text**.
