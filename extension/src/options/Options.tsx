  ...
  return (
    <div className="mx-auto max-w-xl space-y-8 p-10">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-display text-lg font-bold tracking-wide">Security Co Settings</h1>
      ...
      <section className="glass rounded-xl border border-panel-line p-6 shadow-card">
        ...
        <p className="mt-1.5 text-xs leading-relaxed text-fog-faint">
          Point the extension at your running Security Co backend (<code className="rounded bg-panel-raised px-1.5 py-0.5 font-mono text-[11px] text-fog-dim">uvicorn api.app:app</code> in{" "}
      ...
      <p className="text-center font-mono text-xs text-fog-faint">Security Co — v1.0.0</p>
    </div>
  );
}
