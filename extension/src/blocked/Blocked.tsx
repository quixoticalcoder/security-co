  ...
  return (
    <div className="glass w-[440px] rounded-2xl border border-threat-critical/30 p-8 shadow-glow-critical">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="font-display text-base font-bold text-threat-critical">Blocked by Security Co</p>
      ...
      <p className="mt-5 text-sm leading-relaxed text-fog-dim">
        ...
        added to your blocklist, so Security Co stopped this page from loading.
      </p>
